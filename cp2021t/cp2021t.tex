...
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\;\Varid{x}\;(\Conid{Nat}\;\Varid{x}\;\Conid{Nat})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\;\Varid{x}\;\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\llparenthesis\, \Varid{g}\,\rrparenthesis\;\Varid{x}\;\llparenthesis\, \Varid{g}\,\rrparenthesis}}
           \ar[l]_-{\ensuremath{\mathbf{in}}}
\\
     \ensuremath{\Conid{A}\times\Conid{Nat}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{A}\;\Varid{x}\;\Conid{Nat})\;\Varid{x}\;(\Conid{A}\;\Varid{x}\;\Conid{Nat})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
