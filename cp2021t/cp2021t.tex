...
\\
\>[B]{}\Varid{g\char95 eval\char95 exp4}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{if}\;\Varid{a}\equiv \Conid{Negate}\;\mathbf{then}\mathbin{-}\Varid{b}\;\mathbf{else}\;\Varid{\Conid{Prelude}.exp}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 sd\char95 gen4}\;(\Varid{o},((\Varid{exp1},\Varid{exp2}),(\Varid{exp3},\Varid{exp4})))\mathrel{=}\mathbf{if}\;\Varid{o}\equiv \Conid{Sum}\;\mathbf{then}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{exp1}\;\Varid{exp3},\Conid{Bin}\;\Conid{Sum}\;\Varid{exp2}\;\Varid{exp4}){}\<[E]%
\\
\>[B]{}\hsindent{45}{}\<[45]%
\>[45]{}\mathbf{else}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp1}\;\Varid{exp3},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp1}\;\Varid{exp4})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp2}\;\Varid{exp3})){}\<[E]%
\\
\>[B]{}\Varid{g\char95 sd\char95 gen5}\;(\Varid{o},(\Varid{exp1},\Varid{exp2}))\mathrel{=}\mathbf{if}\;\Varid{o}\equiv \Conid{Negate}\;\mathbf{then}\;(\Conid{Un}\;\Varid{o}\;\Varid{exp1},\Conid{Un}\;\Varid{o}\;\Varid{exp2}){}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{else}\;(\Conid{Un}\;\Varid{o}\;\Varid{exp1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Varid{o}\;\Varid{exp1})\;\Varid{exp2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{g\char95 ad3}\;(\Varid{o},((e_1 ,e_2 ),(\Varid{e3},\Varid{e4})))\mathrel{=}\mathbf{if}\;\Varid{o}\equiv \Conid{Sum}\;\mathbf{then}\;(e_1 \mathbin{+}\Varid{e3},e_2 \mathbin{+}\Varid{e4}){}\<[E]%
\\
\>[B]{}\hsindent{45}{}\<[45]%
\>[45]{}\mathbf{else}\;(e_1 \mathbin{*}\Varid{e3},e_1 \mathbin{*}\Varid{e4}\mathbin{+}e_2 \mathbin{*}\Varid{e3}){}\<[E]%
\\
\>[B]{}\Varid{g\char95 ad4}\;(\Varid{o},(e_1 ,e_2 ))\mathrel{=}\mathbf{if}\;\Varid{o}\equiv \Conid{Negate}\;\mathbf{then}\;(\Varid{negate}\;e_1 ,\Varid{negate}\;e_2 ){}\<[E]%
\\
\>[B]{}\hsindent{39}{}\<[39]%
\>[39]{}\mathbf{else}\;(\Varid{\Conid{Prelude}.exp}\;e_1 ,(\Varid{\Conid{Prelude}.exp}\;e_1 )\mathbin{*}e_2 ){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
