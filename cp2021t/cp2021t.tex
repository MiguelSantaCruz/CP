...
\end{eqnarray*}
Para descobrir o gene \ensuremath{\Varid{g\char95 eval\char95 exp}} temos \ensuremath{\Varid{k}\mathrel{=}\cata{\Varid{g\char95 eval\char95 exp}}} sabendo \ensuremath{\Varid{k}\comp \mathbf{in}\mathrel{=}\Varid{g}\comp (\Varid{id}\mathbin{+}(\Varid{k}\times\Varid{k}))} .
\\
Portanto:

\begin{eqnarray}
\start
\ensuremath{\Varid{k}\comp \alt{\underline{\Conid{X}}}{\Varid{num\char95 ops}}\mathrel{=}\alt{\Varid{g}\comp i_1}{\Varid{g}\comp i_2\comp (\Varid{k}\times\Varid{k})}}
%
\just\equiv{ Eq-+ }
%
        \ensuremath{\begin{lcbr}\Varid{k}\comp \underline{\Conid{X}}\mathrel{=}\Varid{g}\comp i_1\\\Varid{k}\comp \Varid{num\char95 ops}\mathrel{=}\Varid{g}\comp i_2\end{lcbr}}
%
\just\equiv{ Def. num ops; Natural-id; Reflexão-+ }
%
        \ensuremath{\begin{lcbr}\Varid{k}\comp \underline{\Conid{X}}\mathrel{=}\Varid{g}\comp i_1\\\Varid{k}\comp \alt{\Conid{N}}{\Varid{ops}}\mathrel{=}\Varid{g}\comp i_2\comp \alt{i_1}{i_2}\end{lcbr}}
%
\just\equiv{ Eq-+ (no segundo ramo) }
%
\left\{
   \begin{array}{lll}
      \ensuremath{\Varid{k}\comp \underline{\Conid{X}}\mathrel{=}i_1}\\
      \ensuremath{\Varid{k}\comp \Conid{N}\mathrel{=}\Varid{g}\comp i_2\comp i_1}\\
      \ensuremath{\Varid{k}\comp \Varid{ops}\mathrel{=}\Varid{g}\comp i_2\comp i_2}
  \end{array}
\right.
%
\just\equiv{ Def. ops }
...
\left\{
   \begin{array}{llll}
      \ensuremath{\Varid{k}\comp \underline{\Conid{X}}\mathrel{=}i_1}\\
      \ensuremath{\Varid{k}\comp \Conid{N}\mathrel{=}\Varid{g}\comp i_2\comp i_1}\\
      \ensuremath{\Varid{k}\comp \alt{\Varid{bin}}{\uncurry{\Conid{Un}}}\mathrel{=}\Varid{g}\comp i_2\comp i_2\comp \alt{i_1}{i_2}}
  \end{array}
\right.
%
\just\equiv{ Eq-+ }
...
\left\{
   \begin{array}{llll}
      \ensuremath{\Varid{k}\comp \underline{\Conid{X}}\mathrel{=}i_1}\\
      \ensuremath{\Varid{k}\comp \Conid{N}\mathrel{=}\Varid{g}\comp i_2\comp i_1}\\
      \ensuremath{\Varid{k}\comp \Varid{bin}\mathrel{=}\Varid{g}\comp i_2\comp i_2\comp i_1}\\
      \ensuremath{\Varid{k}\comp \uncurry{\Conid{Un}}\mathrel{=}\Varid{g}\comp i_2\comp i_2\comp i_2}
  \end{array}
\right.
%
\just\equiv{ Pointwise }
...
\left\{
   \begin{array}{llll}
      \ensuremath{\Varid{k}\;\underline{\Conid{X}}\mathrel{=}i_1\;()}\\
      \ensuremath{\Varid{k}\;(\Conid{N}\;\Varid{a})\mathrel{=}\Varid{g}\comp i_2\comp i_1\;(\Varid{a})}\\
      \ensuremath{\Varid{k}\;(\Conid{Bin}\;\Varid{o}\;\Varid{l}\;\Varid{r})\mathrel{=}\Varid{g}\comp i_2\comp i_2\comp i_1\;(\Varid{o},(\Varid{l},\Varid{r}))}\\
      \ensuremath{\Varid{k}\;(\Conid{Un}\;\Varid{o}\;\Varid{e})\mathrel{=}\Varid{g}\comp i_2\comp i_2\comp i_2\;(\Varid{o},\Varid{e})}
    \end{array}
\right.
\qed
\end{eqnarray}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_1\;\Varid{a})\mathrel{=}\Varid{n};{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_1\;(\Varid{a})))\mathrel{=}\Varid{a};{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},(\Varid{a},\Varid{b})))))\mathrel{=}\Varid{a}\mathbin{*}\Varid{b};{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},(\Varid{a},\Varid{b})))))\mathrel{=}\Varid{a}\mathbin{+}\Varid{b};{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{b}))))\mathrel{=}(\mathbin{-}\mathrm{1})\mathbin{*}\Varid{b};{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{b}))))\mathrel{=}\Varid{expd}\;\Varid{b};{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrixcolsep{0.5pc}\xymatrixrowsep{5pc}
\centerline{\xymatrix{
   ExpAr A \ar[d]_-{\ensuremath{\cata{\Varid{sd\char95 gene}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{out}}} & \qquad \cong
...
\end{eqnarray*}
Para descobrir o gene \ensuremath{\Varid{sd\char95 gene}} temos \ensuremath{\Varid{k}\mathrel{=}\cata{\Varid{sd\char95 gene}}} sabendo \ensuremath{\Varid{k}\comp \mathbf{in}\mathrel{=}\Varid{g}\comp (\Varid{id}\mathbin{+}(\Varid{k}\times\Varid{k}))} .
\\
Portanto:
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g3}}{\alt{\Varid{g5\char95 sd\char95 g}}{\Varid{g6\char95 sd\char95 g}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{g5\char95 sd\char95 g}\;(\Varid{op},((\Varid{exp1},\Varid{exp2}),(\Varid{exp3},\Varid{exp4})))\mathrel{=}\mathbf{if}\;\Varid{op}\equiv \Conid{Sum}\;\mathbf{then}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{exp1}\;\Varid{exp3},\Conid{Bin}\;\Conid{Sum}\;\Varid{exp2}\;\Varid{exp4}){}\<[E]%
\\
\>[B]{}\hsindent{47}{}\<[47]%
\>[47]{}\mathbf{else}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp1}\;\Varid{exp3},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp1}\;\Varid{exp4})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{exp2}\;\Varid{exp3})){}\<[E]%
\\
\>[B]{}\Varid{g6\char95 sd\char95 g}\;(\Varid{op},(\Varid{exp1},\Varid{exp2}))\mathrel{=}\mathbf{if}\;\Varid{op}\equiv \Conid{Negate}\;\mathbf{then}\;(\Conid{Un}\;\Varid{op}\;\Varid{exp1},\Conid{Un}\;\Varid{op}\;\Varid{exp2}){}\<[E]%
\\
\>[B]{}\hsindent{33}{}\<[33]%
\>[33]{}\mathbf{else}\;(\Conid{Un}\;\Varid{op}\;\Varid{exp1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Varid{op}\;\Varid{exp1})\;\Varid{exp2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newline
\textbf{ad\_gen}
...
\centerline{\xymatrix{
   ExpAr A \ar[d]_-{\ensuremath{\cata{\Varid{ad\char95 gen}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{out}}} & \qquad \cong
&   1 + (A + (BinOp \times (ExpAr A \times ExpAr A)) + (UnOp \times ExpAr A)) \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{ad}\times\Varid{ad})\mathbin{+}\Varid{id}\times\Varid{ad}))}}
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\mathbf{in}}}
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_1\;())\mathrel{=}(\Varid{n},\mathrm{1});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_2\;(i_1\;(\Varid{a})))\mathrel{=}(\Varid{a},\mathrm{0});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}((\Varid{a}\mathbin{*}\Varid{c}),(\Varid{a}\mathbin{*}\Varid{d})\mathbin{+}(\Varid{b}\mathbin{*}\Varid{c}));{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{a},\Varid{b})))))\mathrel{=}((\mathbin{-}\mathrm{1})\mathbin{*}(\Varid{a}),(\mathbin{-}\mathrm{1})\mathbin{*}(\Varid{b}));{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{a},\Varid{b})))))\mathrel{=}((\Varid{expd}\;\Varid{a}),(\Varid{expd}\;\Varid{a})\mathbin{*}\Varid{b});{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\;\Varid{x}\;(\Conid{N}\times\Conid{N})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
     \ensuremath{\Conid{A}\times\Conid{Nat}}
&
